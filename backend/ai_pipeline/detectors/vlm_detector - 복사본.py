...
MODEL_DIR = r"C:\Users\samsa\Desktop\26-1\project\backend\ai_pipeline\models"  
...
def analyze_with_vlm(image_bytes: bytes, article_text: str):
    ...
    Task 2: Does the image logically match the text? Provide a confidence score (0-100).
    
    Respond STRICTLY with this JSON format only:
    {{
        "image_analysis_reason": "Step-by-step reasoning...",
        "is_ai_generated_image": true,
        "image_confidence_score": 95,
        "consistency_analysis_reason": "Step-by-step reasoning...",
